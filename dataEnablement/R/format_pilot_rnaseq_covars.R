...
# This script is used to extract clinical and technical variables from the Mayo 
# pilot RNAseq study, which includes AD and PSP samples.
...
pilot_rnaseq_id <- "syn2875340" # pilot RNAseq covariates Excel file
clinical_folder_id <- "syn2875339" # id of destination folder
technical_folder_id <- "syn3162973"

# Download files from Synapse
pilot_rnaseq_file <- synGet(pilot_rnaseq_id)
pilot_rnaseq_path <- getFileLocation(pilot_rnaseq_file)
